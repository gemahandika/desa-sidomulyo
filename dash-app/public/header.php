...
include '../../../app/models/user_models.php';
?>
...
<head>
    ...
    <title>Dashboard Sidomulyo</title>
    <meta
        content="width=device-width, initial-scale=1.0, shrink-to-fit=no"
        name="viewport" />
    <link
        rel="icon"
        href="../../../app/assets/img/desa/Logo_DeliSerdang.png"
        type="image/x-icon" />
    ...
    <script>
        WebFont.load({
            ...
            custom: {
                ...
                urls: ["../../../app/assets/css/fonts.min.css"],
            },
            active: function() {
        ...
        <div class="sidebar" data-background-color="dark">
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="#" class="logo">
                        <img
                            src="../../../app/assets/img/desa/Logo_DeliSerdang.png"
                            alt="navbar brand"
                            class="navbar-brand"
                            height="50" />
                        <h5 class="text-white p-2 mt-2">APP SIDOMULYO</h5>
                    </a>
