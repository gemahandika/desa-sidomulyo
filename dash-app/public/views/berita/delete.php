...
mysqli_query($koneksi, "DELETE FROM tb_berita WHERE id_berita= '$_GET[id]'") or die(mysqli_error($koneksi));
showSweetAlert('success', 'Success', 'Data Berhasil di Hapus', '#dc3545', 'berita.php');
